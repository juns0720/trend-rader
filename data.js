...
const DEBATES = [
  ...
  },
  {
    id: "d02",
    type: "debate",
    title: "얼먹젤리, 편의점마다 비교할 가치 있을까?",
    subtitle: "같은 젤리라도 얼렸을 때 식감이 달라진다는 반응과, 결국 다 비슷하다는 반응이 같이 올라오고 있어요.",
    category: "푸드",
    participants: 1800,
    leftLabel: "비교 가치 있음",
    rightLabel: "다 비슷함",
    ...
    leftArguments: [
      "브랜드별 식감 차이를 보여주기 쉬움",
      "ASMR 컷과 순위 콘텐츠로 재가공 가능",
      "편의점 접근성이 좋아 따라 하기 쉬움",
    ],
    rightArguments: [
      "얼리는 장면 이후 차별점이 약함",
      "비슷한 소리와 비주얼이 반복될 수 있음",
      "짧은 영상에서는 브랜드 차이가 잘 안 보임",
    ],
    featuredComment: {
      author: "스낵픽",
      badge: "T1",
      text: "그냥 비교보다 얼리는 시간별로 나누면 댓글이 더 붙을 것 같아요. 1시간, 4시간, 하루 이렇게요.",
      timeAgo: "34분 전",
    },
    hashtags: ["#얼먹젤리", "#편의점신상", "#ASMR"],
    likes: "3.4K",
    comments: "1.8K",
    shares: "421",
    cover: { hue: 200, sat: 72, lum: 70, label: "FROZEN\nJELLY" },
  },
  {
    id: "d03",
    type: "debate",
    title: "팝업 줄 인증, 아직 콘텐츠로 매력 있을까?",
    subtitle: "줄 길이와 한정 굿즈는 여전히 강하지만, 피로도가 높아져 실제 경험 정보가 더 중요해지고 있어요.",
    category: "플레이스",
    participants: 2400,
    leftLabel: "아직 강함",
    rightLabel: "피로도 높음",
    ...
    leftArguments: [
      "대기 시간 자체가 강한 후킹 포인트",
      "한정 굿즈와 패키지 컷이 공유되기 좋음",
      "지역 기반 저장/공유 수요가 남아 있음",
    ],
    rightArguments: [
      "줄 인증만으로는 새로움이 약함",
      "방문 난도가 높아 대중 확산이 제한됨",
      "운영 시간, 웨이팅 팁이 없으면 정보 가치가 낮음",
    ],
    featuredComment: {
      author: "서울팝업노트",
      badge: "T2",
      text: "줄 사진보다 몇 시에 가면 덜 기다리는지, 굿즈가 언제 빠지는지까지 줘야 저장이 나와요.",
      timeAgo: "2시간 전",
    },
    hashtags: ["#서울팝업", "#웨이팅", "#핫플"],
    likes: "2.7K",
    comments: "2.4K",
    shares: "512",
    cover: { hue: 320, sat: 80, lum: 65, label: "POPUP\nVOTE" },
